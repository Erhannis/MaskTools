...
union() { // Pleat rack
  ...
  HANDLE_DSX = 0;
  HANDLE_A_SX = 44+(SY-6*INCH)/2-HOOK_INTERVAL_ADJUSTMENT/2 + HANDLE_DSX;
  HANDLE_B_SX = 79+(SY-6*INCH)/2-HOOK_INTERVAL_ADJUSTMENT/2 + HANDLE_DSX;
    ...
    union() {
      linear_extrude(height=RACK_SZ) {
        for (ps = [
            ...
            [[-PIER_A_SX+HOOK_L-HOOK_INTERVAL*2,0],[-PIER_A_SX+HOOK_L-HOOK_INTERVAL*2,-HOOK_OUT_NEAR]],
            [[-PIER_A_SX+HOOK_L-HOOK_INTERVAL*2,-HOOK_OUT_NEAR],[-PIER_A_SX-HOOK_INTERVAL*2,-HOOK_OUT_FAR]],
  ...
  difference() { // Rack B - print 2
      ...
      linear_extrude(height=RACK_SZ) {
        for (ps = [
            ...
            // Hook
            [[-PIER_B_SX-HOOK_INTERVAL*2-HOOK_L,0],[-PIER_B_SX-HOOK_INTERVAL*2-HOOK_L,HOOK_OUT_NEAR]],
            [[-PIER_B_SX-HOOK_INTERVAL*2-HOOK_L,HOOK_OUT_NEAR],[-PIER_B_SX-HOOK_INTERVAL*2,HOOK_OUT_FAR]],
